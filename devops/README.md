...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trece-kinsleydavis.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trece-kinsleydavis.tangrama.com.br:
      ansible_user: root
      host: trece-kinsleydavis
      hostname: trece-kinsleydavis.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trece-kinsleydavis.tangrama.com.br.yml` to the remote server with:
